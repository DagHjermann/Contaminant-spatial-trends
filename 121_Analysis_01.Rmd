...
cat("\n gamm_list1: \n")
str(gamm_list1, 1)              # list of 2 lists, "result" and "error"

cat("\n gamm_list1$result: \n")
length(gamm_list1$result)       # list of 555
str(gamm_list1$result[[1]], 1)  # list of 2 data frames, ttable (1 row) and plotvalues (101 rows)
